        ...
        protected void paintComponent(Graphics g) {
            if (!(findLogic.level == -1)) {
                ...
                if (findLogic.level == 0) {
                    ...
                    g.drawString("© Lukáš Kukkuk 2024", 25, 650);
            ...
            if (!(findLogic.level == 0) && !(findLogic.level == -1)) {
                if (findLogic.level == 1 && !(findLogic.isEn())) { // Čestina
                    g.drawString("Tvůj čas: " + findLogic.getTime(), 900, 70);
                } else if (findLogic.level == 1 && findLogic.isEn()) {
                    g.drawString("Your time: " + findLogic.getTime(), 900, 70);
                } else if (findLogic.level == 2 && !(findLogic.isEn())) {  // Čestina
                    g.drawString("Tvůj čas: " + findLogic.getTime(), 900, 70);
                } else if (findLogic.level == 2 && findLogic.isEn()) {
                    g.drawString("Your time: " + findLogic.getTime(), 900, 70);
                } else if (findLogic.level == 3 && !(findLogic.isEn())) { // Čestina
                    g.drawString("Tvůj čas: " + findLogic.getTime(), 900, 70);
                } else if (findLogic.level == 3 && findLogic.isEn()) {
                    g.drawString("Your time: " + findLogic.getTime(), 900, 70);
                } else if (findLogic.level == 4 && !(findLogic.isEn())) { // Čestina
                    g.drawString("Debug", 900, 70);
                } else if (findLogic.level == 4 && findLogic.isEn()) {
                    g.drawString("Debug: " + findLogic.getTime(), 900, 70);
                }
                if (findLogic.isEn()) {
                    g.drawString("Your level: " + findLogic.level, 900, 30);
                } else { // Čestina
                ...
                //Rectangle hráče - debug
                g.drawRect(GameLogic.getPlayer().getRectangle_Player().x, GameLogic.getPlayer().getRectangle_Player().y, GameLogic.getPlayer().getRectangle_Player().width, GameLogic.getPlayer().getRectangle_Player().height);
                ...
                //Rectangle produktu - debug
                g.drawRect(findLogic.getItem().getRectangle_Item().x, findLogic.getItem().getRectangle_Item().y, findLogic.getItem().getRectangle_Item().width, findLogic.getItem().getRectangle_Item().height);
                ...
                for (Enemy enemy: GameLogic.getEnemy()) {
                    ...
                    //Rectangle nepřátele - debug
                    g.drawRect(enemy.getRectangle_Enemy().x, enemy.getRectangle_Enemy().y, enemy.getRectangle_Enemy().height, enemy.getRectangle_Enemy().width);
